...
return; }
 ...
 if (!socioExiste(socioId)) { System.out.println("Socio no registrado"); return; }
 libro.get()[3] = "false";
 ...
 Optional<String[]> libro = buscarLibro(libroId);
 libro.ifPresent(l -> { l[3] = "true"; System.out.println("Librodevuelto: " + l[1]); });
 }
